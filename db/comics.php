...
function getAllComics()
{
    ...
    while (true) {
        ...
        $row = [
            ...
            'comics_name' => $data['comics_name'],
            'comics_image' => $data['comics_image'],
        ];
...
function insertComics(array $data)
{
    $conn = getConnection();
    $sql  = "INSERT INTO comics(comics_name, comics_image) VALUES(:comics_name, :comics_image)";
    $stmt = $conn->prepare($sql);
    $stmt->execute($data);
}
